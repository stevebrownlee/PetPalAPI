...
namespace PetPal.API.Migrations
{
    ...
    [Migration("20250612213533_FixNotificationSettingsUserIdType")]
    partial class FixNotificationSettingsUserIdType
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PetPal.API.Models.CareProvider", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetPal.API.Models.FeedingSchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetPal.API.Models.NotificationSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("FeedingReminders")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("VaccinationReminders")
                        .HasColumnType("boolean");

                    b.Property<bool>("WeightReminders")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("PetPal.API.Models.Weight", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PetPal.API.Models.NotificationSettings", b =>
                {
                    b.HasOne("PetPal.API.Models.UserProfile", "UserProfile")
                        ...
                        .HasForeignKey("PetPal.API.Models.NotificationSettings", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
